...
In collaboration with scientists from NASA's Jet Propulsion Lab (JPL), I participated in SBG High Frequency Timeseries (SHIFT) pathfinder mission for JPL's Surface Biology and Geology Mission that aims to collect plant traits, such as C, N, P content, pigments, etc., and relate them to a dense time series of hyperspectral imagery collected by AVIRIS-NG over the Santa Barbara area. My role was the sampling of plants, soils, and spectra for wetlands that fall within the flight path. I plan on using some of the data collected to improve and adapt soil salinity estimating methods to wetlands and see if we can relate wetland soil salinity in intermittently tidal marshes to wetland plant phenology metrics collected through the campaign. Soil salinity also has potential connections to important carbon and sulfur cycling processes in marshes. I hope to develop ways to track and monitor these things for applications in the management of wetland ecosystems and beyond.   
