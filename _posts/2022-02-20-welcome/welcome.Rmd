...
This is the set up chunk which allows for the setting of rendering options, such as the supression of warnings and messages, but also for the attaching of packages that will be useful through out the task at hand. 
